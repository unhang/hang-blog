import cover from './assets/hang.jpg';
  ...
  return (
    <>
      <div className='w-full h-min-[100vh] px-[32px] md:max-w-[768px] md:mx-auto'>
        <div className="font-[100] mx-auto py-[48px]">
          <h1 className="m-0 text-[98px] md:text-[128px]  relative">
            hあng
            <span className='bg-emerald-600 h-[24px] w-[80px] md:w-[96px] 
                              absolute bottom-[16px] md:bottom-[32px] left-[72px] md:left-[96px] z-[-1]'></span>
          </h1>
        ...
        <div className="w-full my-lg">
          <img className="w-full h-auto d-content" src={cover} alt="" />
        </div>
